...
constexpr const char* OPEN_DISK_HANDLE_FAIL =
    "P?(OpenDiskHandle) from drive fail ... Err=%ld";                                   // 0048c65e
...
constexpr const char* PHYSICAL_DRIVES[] = { Paths::PHYSICAL_DRIVE_1, Paths::PHYSICAL_DRIVE_2,
                                            Paths::PHYSICAL_DRIVE_3, Paths::PHYSICAL_DRIVE_4,
                                            Paths::PHYSICAL_DRIVE_5, Paths::PHYSICAL_DRIVE_6,
                                            Paths::PHYSICAL_DRIVE_7, Paths::PHYSICAL_DRIVE_8 };
...
constexpr const char* CONTROLLER_SIGNATURES[] = { DeviceSignatures::CONTROLLER_1181,
                                                  DeviceSignatures::CONTROLLER_1176 };

constexpr size_t CONTROLLER_SIGNATURES_COUNT =
    sizeof(CONTROLLER_SIGNATURES) / sizeof(CONTROLLER_SIGNATURES[0]);

// Array of supported revisions
constexpr const char* SUPPORTED_REVISIONS[] = { DeviceSignatures::REVISION_A0AA,
                                                DeviceSignatures::REVISION_A1BA };

constexpr size_t SUPPORTED_REVISIONS_COUNT =
    sizeof(SUPPORTED_REVISIONS) / sizeof(SUPPORTED_REVISIONS[0]);
}  // namespace Arrays
}  // namespace ObfuscatedStrings
