...
void HandleIOError(DWORD errorCode, LPCSTR operation) {
    ...
    sprintf(
        errorMessage, "IO Error during %s: %lu", operation ? operation : "operation", errorCode);
...
BOOL CheckAndHandleError(DWORD errorCode, LPCSTR operation) {
    ...
    case ERROR_IO_PENDING: HandleIOError(errorCode, operation); break;

    case ERROR_OUTOFMEMORY:
    case ERROR_NOT_ENOUGH_MEMORY: HandleMemoryError(errorCode, operation); break;

    case ERROR_INVALID_DATA:
    case ERROR_BAD_FORMAT: HandleFirmwareError(errorCode, operation); break;
...
LPCSTR GetErrorDescription(DWORD errorCode) {
    ...
    case ERROR_IO_DEVICE: return "IO device error";
    case ERROR_IO_INCOMPLETE: return "IO operation incomplete";
    case ERROR_IO_PENDING: return "IO operation pending";
