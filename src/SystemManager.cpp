...
BOOL GetSystemVersion(OSVERSIONINFOA* pVersionInfo)
{
    ...
    LogMessage("System version: %lu.%lu.%lu", 
                       ...
                       LPDWORD lpdwDisposition)
{
    ...
    LONG result = RegCreateKeyExA(hKey, lpSubKey, 0, NULL, 
...
BOOL SaveSettingsToRegistry(LPCSTR settingsPath, LPCVOID pSettings, DWORD settingsSize)
{
    ...
    result = WriteRegistryValue(hKey, settingsPath, REG_BINARY, (CONST BYTE*)pSettings, settingsSize);
